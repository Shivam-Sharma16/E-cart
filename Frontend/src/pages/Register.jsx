  ...
  return (
    <div className='mb-[3rem]'>
      <div className='flex flex-col justify-center items-center relative'>
        <i className="text-6xl border-[#00264D] rounded-[50%] p-[1rem] bg-[#00264D] text-white absolute top-[10%]
            ri-user-fill"></i>
        <form onSubmit={handleSubmit(registerHandler)} className='min-h-[65vh] flex flex-col rounded-2xl items-center justify-center gap-[1rem] bg-gray-400/40 w-fit mt-[10rem] p-[2rem]' >

          <div><i className="bg-[#00264D] text-4xl text-white outline-0 font-thin px-[0.5rem] py-[0.5rem]
                 ri-file-image-fill"></i>

            <input className='  bg-[#385273] text-3xl text-white  outline-0 font-thin px-[1rem] py-[0.5rem]'
              {...register("image")} type="url" placeholder='Image Url' /> <br /><small className='text-green-700'>optional</small>
          </div>
          <div><i className="bg-[#00264D] text-4xl text-white outline-0 font-thin px-[0.5rem] py-[0.5rem]
                 ri-home-fill"></i>
            <input className='bg-[#385273] text-3xl text-white outline-0 font-thin px-[1rem] py-[0.5rem]'
          ...
          <div className='flex items-center '>
            ...
            <small>sign up as a seller</small>
          </div>
          <div>
            <input type="checkbox" />
            <small>sign up as a Customer</small>
          </div>
